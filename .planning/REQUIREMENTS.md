...
- [ ] **SLO-01**: A WebSaaS adopter can register a coherent first set of SLOs in one line via `Parapet.SLO.StarterPack.WebSaaS` (HTTP availability, LoginJourney, Oban job success) with documented default objectives and human-terms rationale.
