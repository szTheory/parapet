...
Additive DX and maturity work for the stable 1.x line: SLO registry isolation, flag-based SLO generation, CI/supply-chain hardening, migration/deployment docs, release-maintenance docs, HexDocs branding, and demo Compose validation.
...
Plans:
- [x] 30-01-PLAN.md — Refactor Parapet.SLO.Registry and Parapet.Capabilities to use ETS test checkout pattern for isolation.
