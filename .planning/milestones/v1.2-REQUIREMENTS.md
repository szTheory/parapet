# Requirements Archive: v1.2 Authoring DX & Maturity

**Archived:** 2026-06-03
**Status:** SHIPPED

Fresh active requirements are created by the next `$gsd-new-milestone` run.
...
- [x] **DX-02**: `Parapet.SLO` registry state is moved off the `Application` env to fix test isolation issues.
