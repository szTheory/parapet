defmodule Parapet.Operator.ActionPayloadTest do
  ...
  describe "validation" do
    ...
    test "Payload validation distinguishes immutable factual actions from lightweight narrative edits" do
      ...
      fact_changeset = ActionPayload.changeset(%ActionPayload{}, %{
        actor: "user_1", reason: "testing", correlation_id: "c-1",
        action_type: :immutable_fact
      })
      assert fact_changeset.valid?
      
      edit_changeset = ActionPayload.changeset(%ActionPayload{}, %{
        actor: "user_1", reason: "fixing typo", correlation_id: "c-2",
        action_type: :narrative_edit
      })
      assert edit_changeset.valid?

      invalid_changeset = ActionPayload.changeset(%ActionPayload{}, %{
        actor: "user_1", reason: "bad type", correlation_id: "c-3",
