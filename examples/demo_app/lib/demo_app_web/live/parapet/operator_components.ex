              ...
              <div class="flex items-start gap-3">
                ...
                <div>
                  <p class="text-sm font-medium text-stone-900">
                    Flag <span class="font-mono text-xs bg-stone-100 px-1 rounded border border-stone-200"><span class="break-all min-w-0 tabular-nums font-mono"><%= flag %></span></span> updated
                  </p>
        ...
        <div class="p-4">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
            ...
            <div class="min-w-0">
              ...
              <p class="text-sm font-medium text-stone-900 min-w-0 break-words"><%= preview.data["count"] %></p>
            </div>
          </div>
