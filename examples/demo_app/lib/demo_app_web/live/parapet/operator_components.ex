  ...
  def operator_theme_bootstrap(assigns) do
    ...
    <style>
      ...
      html[data-parapet-theme="system"] .parapet-ui:is(.force-system-dark) {
        color-scheme: dark;
        --parapet-bg: #12100d;
        --parapet-panel: #1c1917;
        --parapet-panel-muted: #292524;
        --parapet-text: #fafaf9;
        --parapet-text-muted: #d6d3d1;
        --parapet-border: #44403c;
        --parapet-border-strong: rgba(250, 250, 249, 0.16);
        --parapet-shadow: 0 1px 2px rgba(0, 0, 0, 0.42), 0 0 0 1px rgba(250, 250, 249, 0.08);
        --parapet-accent: #2dd4bf;
        --parapet-accent-strong: #5eead4;
        --parapet-accent-soft: rgba(45, 212, 191, 0.16);
        --parapet-accent-text: #99f6e4;
        --parapet-warning-bg: rgba(146, 64, 14, 0.24);
