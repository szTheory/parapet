defmodule DemoAppWeb.Parapet.OperatorLive do
            ...
            <div class="mx-auto max-w-6xl">
              ...
              <section class="mt-6 rounded-xl bg-white p-4 shadow-sm ring-1 ring-stone-900/5 md:p-6">
                <div class="mb-5 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
                  ...
                  <.link navigate={@operator_base_path} class="flex min-h-[40px] items-center justify-center rounded-lg px-4 py-2 text-sm font-semibold transition-transform duration-[--motion-fast] ease-out active:scale-[0.96] po-button-primary po-focus">
                    Return to Response
                  </.link>
                </div>
  ...
  defp selected_incident(_params, :response, [%{id: id} | _visible_incidents]) do
    {Parapet.Operator.incident_detail(id), :auto}
  end
